...
public class mvc_View__getModelName_N1191536376 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__getModelName_N1191536376() {
		//Do nothing
	}

	//For internal use only
	mvc_View__getModelName_N1191536376(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"getModelName", argument.getClass().getName(),
	...
	public Object runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''getModelName''");
	...
	public Object __invoke_user_code__(final com.mia.formation.mvc.View current, final com.mia.openapi.gen.Context context, final com.mia.openapi.gen.GenerationServicesManager manager)
{
