...
public class mvc_Action__actionControlerImplementation_N715786133 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Action__actionControlerImplementation_N715786133() {
		//Do nothing
	}

	//For internal use only
	mvc_Action__actionControlerImplementation_N715786133(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"actionControlerImplementation", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''actionControlerImplementation''");
