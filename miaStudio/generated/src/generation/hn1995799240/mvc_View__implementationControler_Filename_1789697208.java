...
public class mvc_View__implementationControler_Filename_1789697208 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__implementationControler_Filename_1789697208() {
		//Do nothing
	}

	//For internal use only
	mvc_View__implementationControler_Filename_1789697208(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"implementationControler$Filename", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''implementationControler$Filename''");
...
_template_buffer.append(manager.action(current, "getModelName"));_template_buffer.append("Controler.java");
