...
public class mvc_ModelProperty__UIComponent_N1402744528 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_ModelProperty__UIComponent_N1402744528() {
		//Do nothing
	}

	//For internal use only
	mvc_ModelProperty__UIComponent_N1402744528(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"UIComponent", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''UIComponent''");
