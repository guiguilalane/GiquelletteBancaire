...
public class mvc_Model__linkGetSetOwnedImpl_N2009986181 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__linkGetSetOwnedImpl_N2009986181() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__linkGetSetOwnedImpl_N2009986181(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"linkGetSetOwnedImpl", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''linkGetSetOwnedImpl''");
