...
public class mvc_UIApplication__allModels_1975488692 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_UIApplication__allModels_1975488692() {
		//Do nothing
	}

	//For internal use only
	mvc_UIApplication__allModels_1975488692(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"allModels", argument.getClass().getName(),
	...
	public Object runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''allModels''");
