...
public class mvc_Model__ModelInterface_N14638476 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_Model__ModelInterface_N14638476() {
		//Do nothing
	}

	//For internal use only
	mvc_Model__ModelInterface_N14638476(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ModelInterface", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ModelInterface''");
...
_template_buffer.append(manager.action(current, "linkScToGetSet"));_template_buffer.append('\n');
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "linkGetSetOwnedElements"));_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append("}");
