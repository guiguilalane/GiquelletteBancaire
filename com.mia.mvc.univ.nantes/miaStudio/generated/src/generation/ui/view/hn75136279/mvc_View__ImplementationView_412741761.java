...
public class mvc_View__ImplementationView_412741761 implements com.mia.studio.kernel.compiler.CompiledAction {

	public mvc_View__ImplementationView_412741761() {
		//Do nothing
	}

	//For internal use only
	mvc_View__ImplementationView_412741761(int anyInt, List anyList) {
			...
			try {			
				...
				throw new IllegalArgumentException(
						String.format(
								...
								"ImplementationView", argument.getClass().getName(),
	...
	public String runAction(java.lang.Object[] _action_parameters) {
		if (_action_parameters.length != 3)
			throw new IllegalArgumentException("Wrong number of parameters in call to ''ImplementationView''");
...
_template_buffer.append(manager.action(current, "importModel"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "importOwnedModel"));_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append('\n');
...
_template_buffer.append(manager.action(current, "getModelName"));_template_buffer.append("Controler controler;");
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "linkAttributModelView"));_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "linkAttributButton"));_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "linkAttributeListForView"));_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append("	/**");
_template_buffer.append('\n');
...
_template_buffer.append(manager.action(current, "getModelName"));_template_buffer.append(" model, I");
_template_buffer.append(manager.action(current, "getModelName"));_template_buffer.append("Controler controler) {");
_template_buffer.append('\n');
...
_template_buffer.append(manager.action(current, "linkAttributImplementation"));_template_buffer.append('\n');
_template_buffer.append("	");
_template_buffer.append('\n');
...
_template_buffer.append(manager.action(current, "linkUIComponent"));_template_buffer.append('\n');
_template_buffer.append("		");
_template_buffer.append('\n');

_template_buffer.append(manager.action(current, "linkUIList"));_template_buffer.append('\n');
_template_buffer.append('\n');
_template_buffer.append('\n');
...
_template_buffer.append(manager.action(current, "linkUIButton"));_template_buffer.append('\n');
_template_buffer.append("	}");
_template_buffer.append('\n');
_template_buffer.append('\n');
